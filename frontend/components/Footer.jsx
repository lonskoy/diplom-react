          ...
          <div className="col">
            <section>
              ...
              <ul className="nav flex-column">
                ...
                <li className="nav-item"><NavLink className="nav-link" to="/catalog">Каталог</NavLink></li>
                <li className="nav-item"><NavLink className="nav-link" to="/contacts">Контакты</NavLink></li>
              </ul>
            </section>
          </div>
          <div className="col">
